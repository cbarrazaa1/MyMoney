...
@interface CashViewController () <UITableViewDataSource, UITableViewDelegate, TransactionViewControllerDelegate>
// Table View //
...
- (void)fetchTransactions {
    ...
    [query whereKey:@"category" equalTo:@"cash"];
    ...
    [query findObjectsInBackgroundWithBlock:
           ^(NSArray * _Nullable objects, NSError * _Nullable error)
           {
               ...
               {
                   NSLog(@"Error trying to get cash transactions.");
               }
